/**
 * GET /api/cron/titans-fr-stop
 * Fires daily at 18:00 UTC (21:00 GMT+3).
 * Parks queued leads and deactivates Titans — FR.
 */
...
export async function GET(request: NextRequest) {
  ...
  console.log(`[titans-fr-stop] deactivated — parked ${data?.length ?? 0}`);
