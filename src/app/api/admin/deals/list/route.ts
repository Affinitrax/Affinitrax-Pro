...
export async function GET() {
  ...
  const { data: deals } = await admin
    .from("deals")
    .select("id, vertical, type, geos, model, volume_daily, budget_usd, rate_usd, status, notes, admin_notes, intake_method, expose_ftd, ftd_label, created_at, requester_id")
